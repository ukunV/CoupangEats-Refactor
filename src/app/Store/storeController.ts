 ...
 */
export const getFoodCategory = async function (req: any, res: any) {
 ...
 */
export const getNewStore = async function (req: any, res: any) {
 ...
 */
export const getStoresByCategoryId = async function (req: any, res: any) {
  const { userId } = req.verifiedToken;
 ...
 */
export const getStore = async function (req: any, res: any) {
 ...
 * path variable: storeId
 */
export const getStoreDelivery = async function (req: any, res: any) {
  const { storeId } = req.params;
 ...
 * path variable: storeId
 */
export const getStoreInfo = async function (req: any, res: any) {
  const { storeId } = req.params;
 ...
 */
export const getMainMenu = async function (req: any, res: any) {
 ...
 * path variable: storeId
 */
export const createStoreLike = async function (req: any, res: any) {
  const { userId } = req.verifiedToken;
 ...
 */
export const deleteStoreLike = async function (req: any, res: any) {
  const { userId } = req.verifiedToken;
 ...
 * query string: filter
 */
export const getStoreLike = async function (req: any, res: any) {
  const { userId } = req.verifiedToken;
